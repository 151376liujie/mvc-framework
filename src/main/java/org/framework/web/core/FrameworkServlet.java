...
public class FrameworkServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (actionHandler != null) {
            ...
            try {
                WebRequestParameterHolder webRequestParameterHolder = new WebRequestParameterHolder(map);
                Object result = null;
                if (webRequestParameterHolder.isEmpty()) {
                    result = ReflectionUtils.invokeMethod(controller, actionMethod);
                } else {
                    result = ReflectionUtils.invokeMethod(controller, actionMethod, webRequestParameterHolder);
                }
